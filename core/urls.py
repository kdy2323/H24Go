...
urlpatterns = [
    ...
    path('client/course/<int:course_id>/annuler/', views.annuler_acceptation, name='annuler_acceptation'),
    ...
    path('coiffeuse/disponibilites/', views.coiffeuse_disponibilites, name='coiffeuse_disponibilites'),
    ...
    path('adminis/website-traiter/<int:demande_id>/', views.traiter_demande_website, name='traiter_demande_website'),
    path('adminis/website-supprimer/<int:demande_id>/', views.supprimer_demande_website, name='supprimer_demande_website'),
